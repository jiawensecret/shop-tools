...
class CreateWarningOrderGoodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        //excel 同订单下 sku 订单号 图片均一致的多商品备份 需要人工核实
        Schema::create('warning_order_goods', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('warning_order_goods');
    }
}
